...
// ELEM-FF: REL99 
//   U8                        ecsc;                     /*<  0:  0> Early Classmark sending flag in PSI2               */
...
//   U8                        ba_ind;                   /*<  0:  0> BA_IND used by RR for neighbor cell list           */
...
// {
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   U8                        nco;                      /*<  0:  0> Network control order, values same as enum T_NC_ORDER in grr.h */
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   U8                        is_valid;                 /*<  0:  0> Indicates whether NC parameters following are valid */
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   U8                        nc_non_drx;               /*<  0:  0> minimum time the mobile station shall stay in non-DRX mode after an NC-measurement report  */
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   U8                        nc_rep_per_i;             /*<  0:  0> Time period for cell reselection measurement reporting for packet idle mode (I)  */
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   U8                        nc_rep_per_t;             /*<  0:  0> Time period for cell reselection measurement reporting for packet transfer mode (T)  */
// } T_nc_para_struct;
// #endif
// 
#ifndef __T_cr_par__
...
//   T_ncell_sync_list         ncell_sync_list[RRGRR_MAX_ARFCN_NCELL_SYNC_REQ]; /*<  0:  0> List of neighbourcell that needs to be synchronised. */
...
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   T_enh_para_struct         enh_para_struct;          /*<  0:  0> Enhanced measurement parameters (type defined in "p_mph.h") */
// ELEM-FF: REL99 AND TI_PS_FF_EMR 
//   T_nc_para_struct          nc_para_struct;           /*<  0:  0> Network control parameters                         */
