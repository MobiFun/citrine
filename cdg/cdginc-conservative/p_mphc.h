...
// typedef struct
// {
//   U8                        radio_band;               /*<  0:  0> Radio Bands Supported                              */
//   U8                        power_class;              /*<  0:  0> Power Class associated with each radio band        */
...
//   U8                        handover_type;            /*<  0:  0> handover type                                      */
} T_MPHC_ASYNC_HO_REQ;
#endif
...
// ELEM-FF: REL99 AND FF_BHO 
//   U32                       fn_offset;                /*<  0:  0> frame offset                                       */
// ELEM-FF: REL99 AND FF_BHO 
//   U32                       time_alignment;           /*<  0:  0> Difference in quarter bits between the first bit in a frame of the serving cell and the first bit in the next frame of the non-serving cell. Validity of time_alignment dependent upon timing_validity indication. (0 - 4999) */
  U8                        _align0;                  /*<  1:  1> alignment                                          */
  U8                        _align1;                  /*<  2:  1> alignment                                          */
  U8                        _align2;                  /*<  3:  1> alignment                                          */
...
//   S16                       rxlev_val_acc;            /*<  0:  0> RXLEV accumuated on SACCH for EMR                  */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U8                        rxlev_val_nbr_meas;       /*<  0:  0> Number of rxlev_val measurements taken on serving cell */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U32                       mean_bep_block_acc;       /*<  0:  0> Accumulated value of Mean Bit Error Probability of a block taken over a reporting period. */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U16                       cv_bep_block_acc;         /*<  0:  0> Accumulated value of coefficient of variation of BEP of a block taken over a reporting period. */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U16                       mean_bep_block_num;       /*<  0:  0> Number of block used to accumulate the MEAN_BEPblock */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U16                       cv_bep_block_num;         /*<  0:  0> Number of block used to accumulate the CV_BEPblock */
// ELEM-FF: REL99 AND ( TI_PS_FF_EMR OR TI_PS_FF_RTD ) 
//   U8                        nbr_rcvd_blocks;          /*<  0:  0> Number of correctly decoded block during a reporting period. */
...
// ELEM-FF: !TI_PS_FF_QUAD_BAND_SUPPORT 
  U8                        param;                    /*<  0:  1> dummy parameter                                    */
// ELEM-FF: TI_PS_FF_QUAD_BAND_SUPPORT 
//   T_multiband_power_class   multiband_power_class[NB_MAX_GSM_BANDS]; /*<  0:  0> Power Class information for multiple bands         */
  U8                        _align0;                  /*<  1:  1> alignment                                          */
  U8                        _align1;                  /*<  2:  1> alignment                                          */
  U8                        _align2;                  /*<  3:  1> alignment                                          */
} T_MPHC_INIT_L1_CON;
